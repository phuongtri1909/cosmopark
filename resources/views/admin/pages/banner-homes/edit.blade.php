    ...
    <div class="form-card">
        <div class="form-header">
            <div class="form-title">
                ...
                <h5>Chỉnh sửa banner trang chủ</h5>
            </div>
            <div class="category-meta">
                <div class="category-created">
                    <i class="fas fa-clock"></i>
                    <span>Ngày tạo: {{ $bannerHome->created_at->format('d/m/Y H:i') }}</span>
                </div>
            </div>
        </div>
        <div class="form-body">
            
            <form action="{{ route('admin.banner-homes.update', $bannerHome) }}" method="POST" class="category-form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    @if($bannerHome->image)
                        <div class="current-image mb-3">
                            <img src="{{ $bannerHome->image_url }}" alt="Banner trang chủ" style="max-width: 300px; max-height: 200px;">
                        </div>
                    @endif
                    ...
                    <div class="form-hint">
                        ...
                        <span>Để trống nếu không muốn thay đổi hình ảnh. Chấp nhận định dạng: JPG, PNG, GIF. Tối đa 2MB. Kích thước khuyến nghị: 1200x600px.</span>
                    </div>
                    @error('image')
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="custom-input {{ $errors->has('sort_order') ? 'input-error' : '' }}" 
                        id="sort_order" name="sort_order" value="{{ old('sort_order', $bannerHome->sort_order) }}" min="0">
                    <div class="form-hint">
                        <i class="fas fa-info-circle"></i>
                ...
                <div class="form-group">
                    <div class="checkbox-group">
                        <input type="checkbox" id="is_active" name="is_active" value="1" 
                            {{ old('is_active', $bannerHome->is_active) ? 'checked' : '' }}>
