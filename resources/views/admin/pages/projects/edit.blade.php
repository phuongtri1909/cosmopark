    ...
    <div class="category-container">
        ...
        <div class="content-card">
            ...
            <div class="form-body">
                ...
                <form action="{{ route('admin.projects.update', $project) }}" method="POST" class="project-form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control"
                                value="{{ old('slug', $project->slug) }}" placeholder="cosmopark-eco-industrial-zone" required>
                            <div class="form-hint">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="number" id="number" class="form-control"
                                value="{{ old('number', $project->number) }}" placeholder="822" required>
                            @error('number')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="unit" id="unit" class="form-control"
                                value="{{ old('unit', $project->unit) }}" placeholder="ha" required>
                            @error('unit')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        @if ($project->hero_image)
                            <div class="current-image mb-2">
                                <img src="{{ asset('storage/' . $project->hero_image) }}" 
                                     alt="Current hero image" width="100" height="100" class="rounded">
                        ...
                        <div class="form-hint">
                            <i class="fas fa-info-circle"></i>
                            <span>Hỗ trợ: jpeg, png, jpg, gif, webp. Tối đa 2MB. Để trống để giữ ảnh hiện tại.</span>
                        </div>
                        @error('hero_image')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="language-fields">
                            <div class="lang-field">
                                ...
                                <input type="text" name="title[vi]" class="form-control"
                                    value="{{ old('title.vi', $project->getTranslation('title', 'vi')) }}" 
                        ...
                        <div class="language-fields">
                            <div class="lang-field">
                                ...
                                <input type="text" name="subtitle[vi]" class="form-control"
                                    value="{{ old('subtitle.vi', $project->getTranslation('subtitle', 'vi')) }}" 
                                    placeholder="Nhập tiêu đề phụ tiếng Việt">
                                @error('subtitle.vi')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="language-fields">
                            <div class="lang-field">
                                ...
                                <textarea name="description[vi]" class="form-control" rows="4"
                                    placeholder="Nhập mô tả tiếng Việt" required>{{ old('description.vi', $project->getTranslation('description', 'vi')) }}</textarea>
                            ...
                            <div class="lang-field">
                                ...
                                <textarea name="description[en]" class="form-control" rows="4"
                                    placeholder="Enter English description" required>{{ old('description.en', $project->getTranslation('description', 'en')) }}</textarea>
                        ...
                        <div class="layout-options">
                            <div class="form-check">
                                <input type="checkbox" name="reverse_row" id="reverse_row" class="form-check-input"
                                    {{ old('reverse_row', $project->reverse_row) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="reverse_col" id="reverse_col" class="form-check-input"
                                    {{ old('reverse_col', $project->reverse_col) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="reverse_image" id="reverse_image" class="form-check-input"
                                    {{ old('reverse_image', $project->reverse_image) ? 'checked' : '' }}>
                        ...
                        <div class="button-options">
                            <div class="form-check">
                                <input type="checkbox" name="show_button" id="show_button" class="form-check-input"
                                    {{ old('show_button', $project->show_button) ? 'checked' : '' }}>
                                <label for="show_button" class="form-check-label">Hiển thị button</label>
                            </div>
                            
                            <div id="button-fields" class="mt-3" style="display: {{ $project->show_button ? 'block' : 'none' }};">
                                <div class="form-group">
                                    <label for="button_url" class="form-label">URL Button</label>
                                    <input type="url" name="button_url" id="button_url" class="form-control"
                                        value="{{ old('button_url', $project->button_url) }}" placeholder="https://example.com">
                                    @error('button_url')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="language-fields">
                                    <div class="lang-field">
                                        ...
                                        <input type="text" name="button_text[vi]" class="form-control"
                                            value="{{ old('button_text.vi', $project->getTranslation('button_text', 'vi')) }}" 
                                            placeholder="Nhập text button tiếng Việt">
                                    ...
                                    <div class="lang-field">
                                        ...
                                        <input type="text" name="button_text[en]" class="form-control"
                                            value="{{ old('button_text.en', $project->getTranslation('button_text', 'en')) }}" 
