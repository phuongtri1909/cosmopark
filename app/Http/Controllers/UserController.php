...
class UserController extends Controller
{
    ...
    {
        $addresses = Auth::user()->addresses()->with(['city.state.country', 'state.country', 'country'])->get();
    ...
    {
        $address = Auth::user()->addresses()->with(['city.state', 'state.country', 'country'])->findOrFail($id);
    ...
    {
        try {
            $stateHasCities = \App\Models\Cities::where('state_id', $request->state_id)->exists();
            ...
            // Only require city if the state has cities
            if ($stateHasCities) {
        ...
        try {
            ...
            // Only add city_id if it's provided and valid
            if ($request->city_id) {
    ...
    public function updateAddress(Request $request, $id)
    {
        ...
        try {
            ...
            // Only update city_id if it's provided
            if ($request->city_id) {
