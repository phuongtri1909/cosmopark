...
class SeoController extends Controller
{
    ...
    public function update(Request $request, SeoSetting $seo)
    {
        $request->validate([
            ...
            'description.vi' => 'required|string|max:500',
            'description.en' => 'required|string|max:500',
            'keywords' => 'required|array',
            'keywords.vi' => 'required|string|max:500',
            'keywords.en' => 'required|string|max:500',
    ...
    public function destroy(SeoSetting $seo)
    {
        ...
        return redirect()->route('admin.seo.index')
            ->with('success', 'SEO settings đã được xóa thành công.');
    }
}
